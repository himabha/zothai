                ...
                if (empty($errors)) {
                    ...
                    if($save == true){
                        ...
                        if (!empty($_POST['verified'])) {
							...
							$planEndDate = date("Y-m-d H:i:s",strtotime($Userdata['plan_end_date']));
							
							if($Verification == 1 && $currentDate > $planEndDate){
								$Update_data['plan_name']       = 3;
								$Update_data['plan_start_date'] = $currentDate;
								$Update_data['plan_end_date']   = date("Y-m-d H:i:s",strtotime('+3 months'));
							}
