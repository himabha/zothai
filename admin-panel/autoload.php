...
$mod_pages = array('dashboard', 'post-settings', 'manage-stickers', 'manage-gifts', 'manage-users', 'online-users', 'manage-stories', 'manage-pages', 'manage-groups', 'manage-posts', 'manage-articles', 'manage-events', 'manage-locations', 'manage-forum-threads', 'manage-forum-messages', 'manage-movies', 'manage-games', 'add-new-game', 'manage-user-ads', 'manage-reports', 'manage-third-psites', 'edit-movie','bank-receipts','job-categories','post-board','manage-jobs');
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <?php } ?>
                     <li <?php echo ($page == 'manage-apps' || $page == 'manage-pages' || $page == 'manage-stickers' || $page == 'add-new-sticker' || $page == 'manage-gifts' || $page == 'add-new-gift' || $page == 'manage-groups' || $page == 'manage-posts' || $page == 'manage-articles' || $page == 'manage-events' || $page == 'manage-locations' ||  $page == 'manage-forum-sections' || $page == 'manage-forum-forums' || $page == 'manage-forum-threads' || $page == 'manage-forum-messages' || $page == 'create-new-forum' || $page == 'create-new-section' || $page == 'manage-movies' || $page == 'add-new-movies' || $page == 'manage-games' || $page == 'add-new-game' || $page == 'edit-movie' || $page == 'pages-categories'|| $page == 'social-post-hub-categories' || $page == 'groups-categories' || $page == 'blogs-categories' || $page == 'products-categories' || $page == 'manage-fund' || $page == 'manage-jobs') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'manage-locations') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-locations'); ?>">Locations</a>
                            </li>
                            ...
                            <li <?php //echo ($page == 'pages-categories' || $page == 'social-post-hub-categories' || $page == 'groups-categories' || $page == 'blogs-categories' || $page == 'products-categories') ? 'class="active"' : ''; 
                            echo ($page == 'social-post-hub-categories' ) ? 'class="active"' : '';
                           
                            ?>>
                                <a href="javascript:void(0);" class="menu-toggle">Social Post Hub Categories</a>
                                <ul class="ml-menu">
                                    <?php  $categories=Wo_GetPostCategories();
                                     $category_id=$_GET['id'];
                                     foreach ($categories as $category) 
                                    { ?>
									<li <?php echo ($category_id == $category['id']) ? 'class="active"' : ''; ?>>
                                        <a href="<?php echo Wo_LoadAdminLinkSettings('social-post-hub-categories').'?id='.$category['id']; ?>">
                                            <span><?=$category['name']." (".$category['en_name'].")"; ?></span>
                                        </a>
                                    </li>
                                <?php } ?>
                    ...
                    <li <?php echo ($page == 'bank-receipts') ? 'class="active"' : ''; ?>>
                     ...
                     <li <?php echo ($page == 'post-board') ? 'class="active"' : ''; ?>>
                        <a href="<?php echo Wo_LoadAdminLinkSettings('post-board'); ?>">
                            <i class="material-icons">category</i>
                            <span>Manage Post Board</span>
                        </a>
                    </li>
                    ...
                    <?php } ?>
					 <?php if ($is_admin == true) { ?>
                    <li <?php echo ($page == 'edit-menu-page' || $page == 'manage-menu-pages' || $page == 'add-new-menu-page') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">description</i>
                            <span>Top Menu</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-menu-pages') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-menu-pages'); ?>">Manage Top Menu</a>
                            </li>
                            <!--<li <?php echo ($page == 'add-new-menu-page') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('add-new-menu-page'); ?>">Add Top Menu</a>
                            </li>-->
                        </ul>
                    </li>
                    <?php } ?>
