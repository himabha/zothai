...
if($wo['loggedin'] == true) {
	...
	if($wo['user']['admin'] == 0 && $wo['user']['verified'] == 1 && $curr_date > $wo['user']['plan_end_date']) 
	{
		$user_id = $wo['user']['user_id'];
		$query_one = " UPDATE " . T_USERS . " SET verified = '0' WHERE `user_id` = {$user_id} ";
