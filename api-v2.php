...
$pages_without_access_token = array('get-site-settings','active_account_sms','auth','send-otp-email','verify-otp','change_password', 'regsiter', 'send-reset-password-email', 'create-account', 'social-login','is-active','two-factor','get-social-posts','get-category-location','active_account_otp','privacy_setting');
$pages_without_loggedin = array('get-site-settings','active_account_sms', 'auth','send-otp-email','verify-otp','change_password', 'regsiter', 'send-reset-password-email', 'create-account', 'social-login','is-active','two-factor','get-social-posts','get-category-location','active_account_otp','privacy_setting');
